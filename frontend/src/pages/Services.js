...
function Services() {
  ...
  return (
    <Container className="services-container my-5">
      <h1 className="text-center mb-5 services-title">
      ...
      <div className="filter-buttons mb-4">
        ...
        <Button
          className={`filter-btn ${
            activeFilter === "electrician" ? "active" : ""
          }`}
      ...
      <div className="services-grid">
        {getFilteredServices().map(([key, service]) => (
          <div
            key={key}
            className={`service-section ${animateCards ? "animate" : ""}`}
          >
            ...
            <div className="problem-description-box mt-5">
              <h3 className="description-section-title">
                Need Help? Describe Your Problem
              </h3>
              <div className="description-content">
                <div className="description-left">
                  ...
                  <Form.Control
                    ...
                    onChange={(e) =>
                      handleProblemDescription(key, e.target.value)
                    }
                  />
                  ...
                  <div className="submit-button-wrapper">
                    <Button
                      ...
                      onClick={() =>
                        handleProblemSubmit(key, problemDescriptions[key])
                      }
                  ...
                  {showEstimates[key] && (
                    <div className="estimate-section">
                      ...
                      <div className="estimate-grid">
                        {Object.entries(
                          serviceGuidelines[key].estimateRanges
                        ).map(([work, range], idx) => (
            ...
            <Form onSubmit={handleSubmitBooking}>
                ...
                <Col md={6}>
                  <Form.Group className="mb-3">
                    ...
                    <Form.Control
                      type="text"
                      value={
                        selectedService.type.charAt(0).toUpperCase() +
                        selectedService.type.slice(1)
                      }
                      disabled
              ...
              <div className="d-grid gap-2">
                <Button
                  ...
                  style={{
                    backgroundColor:
                      selectedService.type === "electrician"
                        ? "#007bff"
                        : "#00a8e8",
                    border: "none",
                    borderRadius: "25px",
      ...
      {bookingStatus && (
        <div
          className={`alert alert-${
            bookingStatus.status === "success" ? "success" : "danger"
